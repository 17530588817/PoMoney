...
import com.heng.R;
import com.heng.adapter.RecordPagerAdapter;
import com.heng.frag_record.IncomeFragment;
import com.heng.frag_record.OutcomeFragment;
...
//        创建适配器
        RecordPagerAdapter pagerAdapter =
                new RecordPagerAdapter(getSupportFragmentManager(), fragmentList);
//        设置适配器
