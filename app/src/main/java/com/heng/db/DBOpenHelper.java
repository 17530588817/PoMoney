...
//      向typetb表当中插入元素
        ...
        db.execSQL(sql, new Object[]{"网购", R.mipmap.ic_gouwu, R.mipmap.ic_gouwu_fs, 0});
        ...
        db.execSQL(sql, new Object[]{"住房缴费", R.mipmap.ic_zhufang, R.mipmap.ic_zhufang_fs, 0});
        db.execSQL(sql, new Object[]{"水电煤", R.mipmap.ic_shuidianfei, R.mipmap.ic_shuidianfei_fs, 0});
        db.execSQL(sql, new Object[]{"通讯流量", R.mipmap.ic_tongxun, R.mipmap.ic_tongxun_fs, 0});
